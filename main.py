...
tf.app.flags.DEFINE_integer("num_training", 10000, "Number of training examples to generate.")
tf.app.flags.DEFINE_integer("num_test", 1000, "Number of test examples to generate.")
